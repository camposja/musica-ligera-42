# Graph Report - musica-ligera-42  (2026-08-24)

## Corpus Check
- 170 files · ~81,919 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1001 nodes · 2101 edges · 52 communities (43 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c89e0d9b`
...
Cohesion: 0.05
Nodes (43): cache, createMoovPatchTransform(), evictAudioCache(), getPlaybackProviders(), resetPlaybackProvidersForTests(), resolveAudio(), PlaybackProvider, PlaybackStream (+35 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (45): GET(), POST(), POST(), tooLarge(), getIosSession(), iosError(), iosJson(), NO_STORE (+37 more)
...
Cohesion: 0.09
Nodes (25): AudioError, AudioStatus, LyricsUiState, PlayerBar(), Ctx, EMPTY, PlayerCtx, PlayerProvider() (+17 more)
...
Cohesion: 0.18
Nodes (9): AddToPlaylistMenu(), PlaylistOption, PlayStatus, Props, SaveStatus, SearchResults(), Props, songPayloadFromTrack() (+1 more)

### Community 10 - "Community 10"
Cohesion: 0.15
Nodes (13): PlaylistOption, Props, Status, ClonePlaylistButton(), Props, Status, UserOption, Props (+5 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (64): DeletePlaylistButton(), Params, canRepairSongMatch(), normalizeSong(), parseAltIds(), serializeAltIds(), chain, fetchVideoDetails() (+56 more)
...
Cohesion: 0.13
Nodes (16): LibrarySearchResults(), CandidateRow(), formatDuration(), parseMetadata(), PickYoutubeMatchModal(), Props, useNowPlaying(), ResultRow() (+8 more)
...
Cohesion: 0.21
Nodes (10): CopyStatus, formatDuration(), parseYoutubeMetadata(), PlaylistOption, Props, ResultRow(), SaveStatus, songPayloadFromYoutube() (+2 more)

### Community 17 - "Community 17"
Cohesion: 0.12
Nodes (19): Props, Props, RecentSearches(), Props, SearchBar(), LoadState, PlaylistOption, Props (+11 more)
...
Cohesion: 0.05
Nodes (59): appUrl(), GET(), GET(), importAutoMatchLimit(), POST(), spotifyErrorResponse(), AppSettings, getAppSettings() (+51 more)
...
Cohesion: 0.13
Nodes (29): applyPatchToChunk(), boxType(), CONTAINERS, durationFieldOffsets(), moovEndIfTruncated(), topLevelBox(), u32(), ver0DurationOffset() (+21 more)

### Community 51 - "Community 51"
Cohesion: 0.16
Nodes (13): AppLayout(), Header(), Props, HeaderMenu(), ErrorView, ImportPlaylistForm(), SessionContext, SessionProvider() (+5 more)
...
Cohesion: 0.13
Nodes (18): CreatePlaylistForm(), FindMissingMatchesButton(), PlaylistList(), Props, RefilterYoutubeButton(), Settings, SettingsForm(), Status (+10 more)

## Knowledge Gaps
- **340 isolated node(s):** `config`, `name`, `version`, `private`, `packageManager` (+335 more)
...
- **Why does `getSession()` connect `Community 1` to `Community 3`, `Community 4`, `Community 11`, `Community 47`, `Community 55`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `truncateAll()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 11`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `unauthorized()` connect `Community 1` to `Community 3`, `Community 11`, `Community 4`, `Community 47`?**
